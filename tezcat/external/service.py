...
class MarketsService:
    ...
    def create_research(self, dataset_id: str, *,
        ...
        version = experiment_from_signature(
            ...
            dataset=dataset)  # dataset identity enters the research hash
        vid = self.registry.register(version)
        manifest = research_manifest(version, dataset, sig)
        # persist the binding registry-side: reports read and cross-check it
        self.registry.save_external_manifest(vid, manifest)
