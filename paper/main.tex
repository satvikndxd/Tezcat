...
\begin{table}[t]
\caption{Subsystem inventory (audited at commit \texttt{16448b4})}
...
the NautilusTrader bridge), and 415 at the audited commit
(\texttt{16448b4}), where all 415 tests pass and the seed-42
determinism gate still reports identical outputs. A stronger
...
\texttt{16448b4}; no number is carried forward from documentation
...
The complete suite comprises \textbf{415 tests, all passing} at the
audited commit ($\approx$37\,s wall time in the development
container), spanning unit, property, determinism, replay, differential,
fault-injection, and integration levels.
...
commit \texttt{16448b45c1c4} (415/415 tests passing). The complete
loop is:
